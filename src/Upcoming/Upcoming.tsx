      ...
      <div className={upcomingStyles.upcoming__wrapper}>
        <div className={upcomingStyles.upcoming__imageWrapper}>
          <img
            src={zeusUrl}
            alt="zeus"
            className={upcomingStyles.upcoming__image}
          />
        ...
        <div
          className={`${upcomingStyles.upcoming__imageWrapper} ${upcomingStyles["upcoming__imageWrapper--1"]}`}
        >
          <img
            src={cowBoy}
            alt="zeus"
            className={`${upcomingStyles.upcoming__image} ${upcomingStyles.upcoming__cowboy}`}
          />
        </div>
        ...
        <div className={upcomingStyles.upcoming__imageWrapper}>
          <div className={upcomingStyles.upcoming__stay}>
            <h3 className={upcomingStyles.upcoming__action}>
              Stay Ahead of
              <br />
              the Curve
            </h3>

            <button className={upcomingStyles.upcoming__button}>
              Summon us
            </button>
          </div>
        </div>
