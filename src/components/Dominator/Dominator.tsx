...
const Dominator = () => {
  return (
    <section className={dominatorStyles.dominator}>
      <h2 className={dominatorStyles.dominator__title}>
        {" "}
        Dominator Play:
        <br />
        Path to Performance
      ...
      <p className={dominatorStyles.dominator__describe}>
